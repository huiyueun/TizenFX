...
{
    class SeamlessAnimator : FrameBrokerBase
    {
        ...
        public SeamlessAnimator(Window window) : base(window)
        {
            this.window = window;
        }

        public void SetUICreator(UICreator uicrator)
        {
            this.uiCreator = uicrator;
        }

        protected override void OnFramePaused()
        {
            uiCreator.isStartingProcess = false;
        }
        protected override void OnFrameCreated()
        {
            uiCreator.isStartingProcess = true;
        }
        ...
        protected override void OnFrameResumed(FrameData frame)
        {
            ...
            isForward = frame.DirectionForward;
            if (isForward == true)
            {
                StoreInitDate();
